...
| D11 | RAG library | RAG-Anything whole-stack / ingest-only / parse-only / ColPali | **proposed: RAG-Anything ingest-only** | 2026-09-08 | ADR-0004; `synthesis/rag-stack-recommendation.md` |
