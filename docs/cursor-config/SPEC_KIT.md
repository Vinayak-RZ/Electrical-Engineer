...
```powershell
.\scripts\cursor-config\install-spec-kit.ps1 -Target "<absolute-path-to-this-repo>"
```
...
.\scripts\cursor-config\install-spec-kit.ps1 -Target "<absolute-path-to-this-repo>" -Tag "vX.Y.Z"
```
