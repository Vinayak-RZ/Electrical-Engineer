# IMPLEMENTATION_PLAN — research phase

This repository’s current execution contract for the **research-only** phase is the
...
**Next:** accept or revise [`research/synthesis/recommendation.md`](research/synthesis/recommendation.md).
